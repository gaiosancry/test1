function BallGame() {
    ...
    this.baffle.style.left = e.clientX - this.baffle.offsetWidth / 2 + 'px';
    }.bind(this));
    ...
    this.subFraction = function() {
        this.fraction.innerText = +this.fraction.innerText - 30;
    ...
    this.timing = function() {
        var d = new Date();
        return Math.floor((d.getTime() - this.actionTime) / 1000);
    };

    // 游戏结束
    this.gameOver = function() {
        this.result.innerHTML = `
            <div>你坚持了：${this.infoTime.innerText} s</div>
        `;
